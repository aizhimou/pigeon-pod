...
- **🎯 스마트 구독 및 미리보기**: YouTube 또는 Bilibili 채널·재생목록 URL을 붙여넣기만 하면 유형을 자동으로 판별하고, 구독 전에 피드 정보와 에피소드 목록을 미리 확인할 수 있습니다.
...
- **📦 과거 에피소드 일괄 다운로드**: 과거 에피소드를 효율적으로 다운로드하도록 특별히 설계되어, 검색·페이지네이션·개별/페이지 단위 선택 후 한 번에 다운로드할 수 있습니다.
...
- **📈 YouTube API 사용량 인사이트**: API 할당량 사용량과 한도를 모니터링해 동기화 작업을 계획하고 예기치 않은 중단을 방지할 수 있습니다.
