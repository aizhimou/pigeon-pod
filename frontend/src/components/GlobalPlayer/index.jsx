...
import { Box, Paper, Group, Text, Image, CloseButton, Modal, ActionIcon, useMantineColorScheme } from '@mantine/core';
...
const GlobalPlayer = () => {
    ...
    // Construct source
    const source = React.useMemo(() => (currentEpisode ? {
    ...
    return (
        <>
            ...
            >
                <Box style={{ position: 'relative', border: '1px solid rgba(255,255,255,0.2)', borderRadius: '8px', overflow: 'hidden', backgroundColor: 'black' }}>
                    {/* Modal Controls */}
                    <Box style={{
                        position: 'absolute',
                        top: 0,
                        ...
                        <Group gap="xs" style={{ pointerEvents: 'auto' }}>
                            <ActionIcon variant="subtle" color="gray" onClick={handleClosePlayer} aria-label="Close">
                    ...
                    <Box style={{
                        ...
                        >
                            ...
                            <Box style={{ minWidth: 0, flex: 1 }}>
                                <Text size="sm" fw={500} truncate>{currentEpisode.title}</Text>
                                <Text size="xs" c="dimmed" truncate>{feedTitle}</Text>
                            </Box>
                        </Group>
