...
public interface PlaylistMapper extends BaseMapper<Playlist> {
  ...
  @Select(
      "SELECT p.id, p.owner_id, p.custom_title, p.title, p.custom_cover_ext, p.cover_url, p.description, p.source, p.audio_quality, p.last_updated_at, p.auto_download_enabled, p.auto_download_delay_minutes, "
